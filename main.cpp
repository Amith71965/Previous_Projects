...
int main()
{
    ...
    do
    {
        ...
        cout<<" \n HEY AMIT TO PROCEED PLEASE ENTER YOUR PASSWORD \n";
        string phrase = "HEY AMIT TO PROCEED PLEASE ENTER YOUR PASSWORD";
        string cmnd = "espeak \"" + phrase + "\"";
        const char *charCommand = cmnd.c_str();
        system(charCommand);
        ...
        if(pswd=="amit_71965")
        {
            ...
            do{
                ...
                {
                    cout<<"HII AMIT! HOW CAN I HELP YOU \n";
                    string phrase = "HII AMIT";
                    string cmnd = "espeak \"" + phrase + "\"";
                    const char *charCommand = cmnd.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"My name is Jarvis.I am a voice assistant created by Amit.\n";
                    string phrase = "My name is Jarvis and I am a voice assistant created by Amit";
                    string cmnd = "espeak \"" + phrase + "\"";
                    const char *charCommand = cmnd.c_str();
                    system(charCommand);
                }
        ...
        else
                {
                    ...
                    string phrase = "YOUR PASSWORD IS INCORRECT, PLEASE TRY AGAIN";
                    string cmnd = "espeak \"" + phrase + "\"";
                    const char *charCommand = cmnd.c_str();
                    system(charCommand);
                }
